...
class YoutubeDL:
    ...
    def prepare_outtmpl(self, outtmpl, info_dict, sanitize=False):
        ...
        def filename_sanitizer(key, value, restricted=self.params.get('restrictfilenames')):
            # TODO: add the condition for filesystems (e.g. FAT32)
            windows = self.params.get('windowsfilenames') or sys.platform == 'win32'
            return sanitize_filename(str(value), restricted=restricted, windows=windows, is_id=(
